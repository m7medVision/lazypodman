...
func englishSet() TranslationSet {
	return TranslationSet{
		...
		CannotAccessDockerSocketError:     "Can't access podman socket at: unix:///var/run/podman.sock\nRun lazypodman as root or read https://docs.podman.com/install/linux/linux-postinstall/",
