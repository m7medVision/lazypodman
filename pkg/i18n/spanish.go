...
func spanishSet() TranslationSet {
	return TranslationSet{
		...
		CannotAccessDockerSocketError: "No es posible acceder al podman socket en: unix:///var/run/podman.sock\nEjecuta lazypodman como root o lee https://docs.podman.com/install/linux/linux-postinstall/",
