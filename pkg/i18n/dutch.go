...
func dutchSet() TranslationSet {
	return TranslationSet{
		...
		CannotAccessDockerSocketError:     "Kan de podman socket niet bereiken: unix:///var/run/podman.sock\nDraai lazypodman als root of lees https://docs.podman.com/install/linux/linux-postinstall/",
		...
		ConfigTitle:               "Config",
		EnvTitle:                  "Env",
		DockerComposeConfigTitle:  "Compose Configuratie",
		TopTitle:                  "Top",
		StatsTitle:                "Stats",
		CreditsTitle:              "Over",
