...
func frenchSet() TranslationSet {
	return TranslationSet{
		...
		CannotAccessDockerSocketError:     "Impossible d'accéder au socket Podman à : unix:///var/run/podman.sock\nLancez lazypodman en tant que root ou alors lisez https://docs.podman.com/install/linux/linux-postinstall/",
		...
		ConfigTitle:               "Config",
		EnvTitle:                  "Env",
		DockerComposeConfigTitle:  "Config Compose",
		TopTitle:                  "Top",
