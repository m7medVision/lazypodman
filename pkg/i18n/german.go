...
func germanSet() TranslationSet {
	return TranslationSet{
		...
		CannotAccessDockerSocketError:     "Kann nicht auf den Socket zugreifen: unix:///var/run/podman.sock\nFühre lazypodman als root aus oder lese https://docs.podman.com/install/linux/linux-postinstall/",
		...
		EnvTitle:                  "Env",
		DockerComposeConfigTitle:  "Compose Konfiguration",
		TopTitle:                  "Top",
